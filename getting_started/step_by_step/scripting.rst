...
Before continuing, make sure to skim the :ref:`GDScript<doc_gdscript>` reference and bookmark it
for later. GDScript is a language designed to be simple, and the reference is structured into
sections to make it easier to get an overview of the concepts.
